...
2. 将本 variant 的 skills/ 复制到 40-agents/skills/（覆盖共享版 vault-rules/raw-refine 之外的 skills）
3. 将本 variant 的 templates/me/ 复制到 00-me/ 对应子目录（覆盖共享版同名文件）
4. 将本 variant 的 templates/flow/ 复制到 30-flow/ 对应子目录
5. 将本 variant 的 templates/assets/ 复制到 60-assets/内容模板/
